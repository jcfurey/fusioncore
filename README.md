...
**ROS 2 sensor fusion: IMU + wheel encoders + GPS fused via UKF at 100 Hz. 22-state filter with IMU bias estimation, adaptive noise covariance, chi-squared outlier rejection on every sensor, dual IMU support, GPS velocity fusion for wheel slip detection, and radar Doppler ego-velocity fusion.**
